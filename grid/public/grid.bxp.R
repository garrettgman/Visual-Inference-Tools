...
bxpGrob = function(x5, at, width, cols=rep("black", 3), horiz=TRUE, show.w=TRUE,
  ...
  igt = gTree(x5=x5, at=at, width=width, cols=cols, horiz=horiz, show.w=show.w,
              gp=gp, name=name, vp=vp, cl="bxp")
  igt
}
...
drawDetails.bxp = function(x, recording){
  x = setBxpGrob(x)
